...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: { path: string; priority: number; freq: MetadataRoute.Sitemap[number]['changeFrequency'] }[] = [
    ...
    { path: '/shop', priority: 0.95, freq: 'weekly' },
    { path: '/flavours', priority: 0.9, freq: 'weekly' },
    { path: '/subscribe', priority: 0.85, freq: 'monthly' },
    { path: '/bundle', priority: 0.8, freq: 'monthly' },
    ...
    { path: '/rewards', priority: 0.6, freq: 'monthly' },
    { path: '/faq', priority: 0.6, freq: 'monthly' },
    { path: '/journal', priority: 0.7, freq: 'weekly' },
    { path: '/stockists', priority: 0.55, freq: 'monthly' },
    { path: '/wholesale', priority: 0.5, freq: 'yearly' },
    { path: '/contact', priority: 0.5, freq: 'yearly' },
    { path: '/shipping', priority: 0.5, freq: 'yearly' },
